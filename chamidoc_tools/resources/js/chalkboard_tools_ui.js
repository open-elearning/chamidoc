 ...
 */
 function inVideoManager(){
    ...
    h += ' src="'+_p['web_plugin'] + 'chamidoc_tools/rendercache/import-package/css/download-local.svg" /></a></p>';
...
function inUploadManager(){
    ...
    h += '<iframe src="' + _p['web_plugin'];
    h += 'chamidoc_tools/plug/';
